...
current_dir = os.path.dirname(os.path.abspath(__file__)); current_dir = os.path.join(current_dir, "..")
current_dir = os.path.join(current_dir, ".."); current_dir = os.path.join(current_dir, "logs")


"""Generate a chatlog id to save conversation"""
...
def ID_Gen(lenght: int = 6) -> str:
    ...
    idStr: str = "".join(id); idStr = os.path.join(current_dir, f"Aness@{idStr}.txt")
    return idStr

"""Create time of the log file"""
@functools.lru_cache(maxsize=None)
